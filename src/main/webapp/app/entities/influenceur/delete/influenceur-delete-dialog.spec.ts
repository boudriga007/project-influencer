...
import { InfluenceurDeleteDialog } from './influenceur-delete-dialog';

describe('Influenceur Management Delete Component', () => {
  let comp: InfluenceurDeleteDialog;
  let fixture: ComponentFixture<InfluenceurDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(InfluenceurDeleteDialog);
