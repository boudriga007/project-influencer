...
import { ScoreReachDeleteDialog } from './score-reach-delete-dialog';

describe('ScoreReach Management Delete Component', () => {
  let comp: ScoreReachDeleteDialog;
  let fixture: ComponentFixture<ScoreReachDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScoreReachDeleteDialog);
