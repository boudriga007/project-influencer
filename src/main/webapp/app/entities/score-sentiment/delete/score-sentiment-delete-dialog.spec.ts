...
import { ScoreSentimentDeleteDialog } from './score-sentiment-delete-dialog';

describe('ScoreSentiment Management Delete Component', () => {
  let comp: ScoreSentimentDeleteDialog;
  let fixture: ComponentFixture<ScoreSentimentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScoreSentimentDeleteDialog);
