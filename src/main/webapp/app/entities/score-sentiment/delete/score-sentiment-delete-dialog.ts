...
@Component({
  templateUrl: './score-sentiment-delete-dialog.html',
  imports: [FormsModule, FontAwesomeModule, AlertError],
})
export class ScoreSentimentDeleteDialog {
  scoreSentiment?: IScoreSentiment;
  ...
  confirmDelete(id: number): void {
    this.scoreSentimentService.delete(id).subscribe(() => {
